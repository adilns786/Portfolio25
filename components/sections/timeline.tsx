          ...
          <div className="description-section pt-4">
            ...
            <div className="relative mb-12">
              ...
              <p className="text-[#555555] text-lg leading-relaxed max-w-[600px]">
                Deniz is a UI/UX designer from Germany — Stuttgart who blends
                function with emotion. As a Framer, Contra, and Shopify Partner,
                he helps startups and companies create clear interfaces, strong
                brands, and inspiring digital experiences.
              </p>
            </div>
